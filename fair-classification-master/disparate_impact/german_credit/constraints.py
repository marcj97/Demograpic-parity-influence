...
def test_adult_data():
	...
	""" Load the adult data """
	X, y, x_control = load_credit_data(load_data_size=None) # set the argument to none, or no arguments if you want to test with the whole data -- we are subsampling for performance speedup
